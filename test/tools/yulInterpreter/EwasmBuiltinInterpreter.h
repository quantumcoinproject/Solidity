...
private:
	...
	void writeAddress(uint64_t _offset, util::h160 _value) { accessMemory(_offset, 28); writeMemory(_offset, _value.asBytes()); }
	...
	util::h160 readAddress(uint64_t _offset) { accessMemory(_offset, 28); return util::h160(readMemory(_offset, 28)); }
